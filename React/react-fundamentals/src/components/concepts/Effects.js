    ...
    <div className="main">
      <div className="mainDiv">
        ...
        <ul>
          ...
          <li>
            Effect are used to trigger certain actions based upon changes to the
            component.
          </li>
          <li>
            Effects can retrun cleanup function, which can clean up timers using
            memory, listeners to outside APIs, and other functions which may use
            system resources.
          </li>
        </ul>
        <SampleEffect />
...
const SampleEffect = () => {
  ...
  useEffect(() => {
    if (timerRunning) {
      console.log("There has been a state change");
    }
  });
