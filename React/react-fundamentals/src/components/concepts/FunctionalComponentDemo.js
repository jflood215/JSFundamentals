      ...
      <Row>
        <Col xs="12">
          ...
          <dl>
            ...
            <dd>
              Older class compents use 'this', fucntional components have no
              'this' object.
            </dd>
            <dt>Can use effects</dt>
            <dd>
              With the 'useEffect' hook, funtional components can perform side
  ...
  <div>
    <Card>
      <img
        width="100%"
        height="280px"
        src="https://images.unsplash.com/photo-1525011268546-bf3f9b007f6a?ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80"
        alt="Card cap"
      ></img>
      <CardBody>
